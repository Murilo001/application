/**
 * Document containing validations to remove a company safety.
 */
"use strict";

/**
 * Necessary imports.
 * - Joi: Object Schema Validate - Necessary to set rules to name fields.
 * - Promise: Assynchronus callback.
 * - Exception: Catch exceptions and show in good way to understanding.
 * - Models: Data model.
 */
const
  Joi       = require('joi'),
...
const
  ...
  /**
 * The class CompanyRemover implements all operations to safety remove one company.
 * Following these steps:
 * - Recieve arguments:
 * @param {String} company,
 * @param {User} user logged,
 * @param {String} confirm name of company.
 * - Verify company name and confirm name.
 * - Throw error message, 
 * @throws Provided name confirmation does not match company one
 * - Ensure User belongs to current company and is admin
 * - Remove company and children records.
 */
