...
//En: Change in user registration
//Pt-Br: Alteração do cadastro de usuário
router.post('/edit/:user_id/', function (req, res) {
  ...
  Promise.try(function () {
    ...
    .then(function (company) {
      ...
      //En: Validation and encapsulation of user attributes
      //Pt-Br: Validação e encapsulamento dos atributos de usuário
      new_user_attributes = get_and_validate_user_parameters({
        req: req,
        item_name: 'user',
        departments: company.departments,
    ...
    .then(function () {
      ...
      // En: Update user record
      // Pt-Br: Alteração de usuário na base de dados
      employee.updateAttributes(new_user_attributes)
...
//En: Validate user's attributes
//Validação dos atributos de usuário
function get_and_validate_user_parameters(args) {
  ...
  var name = validator.trim(req.param('name')),
    ...
    activated = validator.toBoolean(req.param('activated')),
